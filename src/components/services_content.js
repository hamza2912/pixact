      ...
      <section id="servicePage" className='w-full h-screen py-2 bg-black'>
        <div className='home-content lg:pl-24 pl-12 w-full h-full flex items-center'>
          <div className='w-full lg:px-40 px-5 flex flex-col text-white'>
            ...
            <p data-aos='fade-right' className='lg:text-sm text-xs lg:mt-10 mt-5'>We are so much more than an innovative and dynamic software agency – we are an extension to your team.</p>
            <div className='w-full h-auto flex lg:flex-row flex-col lg:mt-10 mt-5'>
              <div className='lg:w-1/4 w-4/5 flex flex-col'>
                <ul className='w-full'>
                  ...
                  <li data-aos="fade-right" data-aos-delay="250" id='data' className='flex flex-row px-4 py-2 border w-full text-white items-center mb-4 cursor-pointer services-options overflow-hidden'>
                    <i className="fab fa-hive mr-4"></i>
                    <h2 className='lg:text-lg text-sm '>NFT</h2>
                    <div className='border-r-4 h-1/3 absolute opacity-0 top-0 left-0 border-red-600 float-around-box'></div>
                  </li>
              ...
              <div data-aos="fade-up" data-aos-delay="150" className='lg:w-3/4 w-full lg:h-80 h-auto flex flex-col lg:pl-10'>
                <div id='ui-content' className='services-content w-full'>
                  ...
                  <p className='lg:text-sm text-xs mt-2 mb-4'>We believe in providing a thoughtful and polished UI experience followed by the design thinking methodology. We understand and empathize with your problem, ideate and analyze different possible solutions and translate them to pixel-perfect designs.</p>
                ...
                <div id='dev-content' className='services-content w-full hidden'>
                  ...
                  <p className='lg:text-sm text-xs mt-2 mb-4'>We put life into designs by writing clean, reusable, and scalable code, raising no questions on responsiveness and compatibility. In addition to mastering frontend skills, we are experts at building both client and server-based applications.</p>
                ...
                {/* <div id='data-content' className='services-content w-full hidden'>
                  ...
                  <p className='lg:text-sm text-xs mt-2 mb-4'>We help transform businesses by enabling them to make sharper, critical, and informed decisions using digital data. We derive valuable insights to make smarter data-driven decisions.</p>
                ...
                <div id='data-content' className='services-content w-full hidden'>
                  ...
                  <p className='lg:text-sm text-xs mt-2 mb-4'>We help founders launch disrupting web3 Projects. Work with us to launch your own successful NFT collection.</p>
                ...
                <div id='digi-content' className='services-content w-full hidden'>
                  ...
                  <p className='lg:text-sm text-xs mt-2 mb-4'>We provide effective and productive digital marketing solutions to help you achieve more leads and sales through your digital assets and get you in front of your target audience at the right time and on the right digital screen. </p>
