                    ...
                    <div className='w-full h-full grid grid-rows-3'>
                        ...
                        <div data-aos='fade-up' data-aos-delay='50' className='flex lg:flex-row flex-col lg:px-48 px-5 text-white relative z-10 items-center work -mt-5 lg:-mt-0'>
                            <div className='lg:w-1/2 w-full lg:h-full h-auto flex flex-col z-10 mb-5 lg:mb-0'>
                                <p className='lg:text-sm text-xs text-gray uppercase'>UI UX | Frontend</p>
                                <h1 className='lg:text-5xl text-2xl font-semibold'>Archive 91</h1>
                            </div>
                            <div className='lg:w-1/2 w-full lg:h-full h-auto flex flex-col z-10'>
                                <p className='text-sm max-w-md lg:mt-6 mt-0'>An old fashioned website that sells NFT based digital auctions, demonstrating the archives of a company "Smart World Technologies" back 2000s.</p>
                                <p className='text-sm max-w-md mt-4'>Technologies: Figma, React, Tailwindcss, Firebase etc.</p>
                                <a href="https://archive91.com/" target="_blank" className='lg:text-sm text-xs text-gray uppercase lg:mt-12 mt-6 cursor-pointer hover:text-gray'>Visit the Site <i className="fas fa-angle-right text-gray text-xs"></i></a>
                            </div>
                        ...
                        <div data-aos='fade-up' data-aos-delay='50' className='flex lg:flex-row flex-col lg:px-48 px-5 text-white relative z-10 items-center work mt-5 lg:mt-0'>
                            <div className='lg:w-1/2 w-full lg:h-full h-auto flex flex-col z-10 mb-5 lg:mb-0'>
                                <p className='lg:text-sm text-xs text-gray uppercase'>UI UX | Frontend</p>
                                <h1 className='lg:text-5xl text-2xl font-semibold'>INK Softwares</h1>
                            </div>
                            <div className='lg:w-1/2 w-full lg:h-full h-auto flex flex-col z-10'>
                                <p className='text-sm max-w-md lg:mt-6 mt-0'>A software agency that provides a full custom software development starting with a series of design thinking workshops.</p>
                                <p className='text-sm max-w-md mt-4'>Technologies: Figma, React, jQuery, Tailwindcss etc.</p>
                                <a href="https://ink-software.web.app/" target="_blank" className='lg:text-sm text-xs text-gray uppercase lg:mt-12 mt-6 cursor-pointer hover:text-gray'>Visit the Site <i className="fas fa-angle-right text-gray text-xs"></i></a>
                            </div>
        ...
        return (
            ...
            <section className='w-full h-auto bg-black py-24'>
                <div className='home-content w-full lg:pl-24 pl-12'>
                    ...
                    <Work url="https://archive91.com/" title="Archive 91" subtitle="UI UX | Frontend" description2="Technologies: Figma, React, Tailwindcss, Firebase etc." description="An old fashioned website that sells NFT based digital auctions, demonstrating the archives of a company 'Smart World Technologies' back 2000s." bgClass="bg-service-data"/>
                    <Work url="https://ink-software.web.app/" title="INK Softwares" subtitle="UI UX | Frontend" description2="Technologies: Figma, React, jQuery, Tailwindcss etc." description="A software agency that provides a full custom software development starting with a series of design thinking workshops." bgClass="bg-service-ui"/>
                    <Work url="https://github.com/hamza2912/reactBarcode" title="Barcode Attendance Software" subtitle="Frontend | Backend" description2="Technologies: React, Node.js, MongoDB etc." description="A real-time attendance software that maintains students' attendance records utilizing barcode scans, informs their guardian via SMS, and generates daily weekly, and monthly announcements." bgClass="bg-service-data" code="true"/>
                    ...
                    <Work url="http://dealizle.com/" title="Dealizle" subtitle="Frontend | Backend" description2="Technologies: React, sass, Node.js, MongoDB etc." description="A UAE-based e-commerce store recommended by Gulf News for shopping." bgClass="bg-service-data"/>
