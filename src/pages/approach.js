      ...
      {/* <div className=''> */}
        ...
        <section className='w-full h-screen bg-black'>
          <div className='lg:pl-24 pl-12 w-full h-full flex items-center'>
            <div className='lg:w-2/3 w-full lg:pl-40 px-5 flex flex-col text-white'>
              ...
              <h1 data-aos='fade-right' className='lg:text-6xl text-3xl font-semibold'><span className='text-red-600'>Pixact</span> is a global design and development agency</h1>
              <p data-aos='fade-right' data-aos-delay='100' className='lg:text-2xl text-xl lg:mt-16 mt-6'>Combining insight, creativity and technology to align with culture and connect with people.</p>
            ...
            <div className='w-full h-4/5 lg:px-40 px-5 flex flex-col text-white'>
              <div className='w-full h-full flex lg:flex-row flex-col mt-12'>
                <div className='lg:w-1/2 w-full h-full'>
                  ...
                  <h1 className='lg:text-6xl text-3xl font-semibold'>Align</h1>
                ...
                <div className='lg:w-1/2 w-full lg:pt-40 pt-10t-10 h-full lg:mt-0 mt-5'>
                  ...
                  <p className='lg:text-lg text-sm mt-6' data-aos='fade-up' data-aos-delay='200'>The first step in a successful partnership is to huddle up and learn. We get to know your brand, goals and expectations. From there, we put together an initial plan for the work to come.</p>
            ...
            <div className='w-full h-4/5 lg:px-40 px-5 flex flex-col text-white'>
              <div className='w-full h-full flex lg:flex-row flex-col items-center mt-12'>
                ...
                <div className='lg:w-1/2 w-full mt-5 lg:mt-0'>
                  ...
                  <h1 className='lg:text-6xl text-3xl font-semibold'>Insight</h1>
                  <p data-aos='fade-right' data-aos-delay='100' className='text-base uppercase lg:mt-16 mt-6'>UNDERSTANDING THE WIDER CONTEXT.</p>
                  <p className='lg:text-lg text-sm mt-6' data-aos='fade-up' data-aos-delay='200'>A great plan requires real insight. We quickly get up to speed on your consumers, relevant cultural trends, the marketplace, and more. It’s about getting the lowdown on what matters most to ensure success.</p>
            ...
            <div className='w-full h-3/5 lg:px-40 px-5 flex flex-col text-white'>
              <div className='w-full h-full flex lg:flex-row flex-col mt-12'>
                <div className='lg:w-1/2 w-full h-full'>
                  ...
                  <h1 className='lg:text-6xl text-3xl font-semibold'>Opportunity</h1>
                  <p data-aos='fade-right' data-aos-delay='100' className='text-base uppercase lg:mt-16 mt-6'>SHARPENING THE FOCUS.</p>
                  <p className='lg:text-lg text-sm mt-6' data-aos='fade-up' data-aos-delay='200'>With a deep understanding in place, it’s time to apply it. We find the vital overlap between your business needs and those of your consumers – the sweet spot where shared value lies. Now we define metrics for success.</p>
            ...
            <div className='w-full h-4/5 lg:px-40 px-5 flex flex-col text-white'>
              <div className='w-full h-full flex lg:flex-row flex-col mt-12'>
                <div className='lg:w-1/2 w-full h-full'>
                  ...
                  <h1 className='lg:text-6xl text-3xl font-semibold'>Concept Design</h1>
            ...
            <div className='w-full h-3/5 lg:px-40 px-5 flex flex-col text-white'>
              <div className='w-full h-full flex lg:flex-row flex-col items-center mt-12'>
                <div className='lg:w-1/2 w-full h-full'>
                  ...
                  <h1 className='lg:text-6xl text-3xl font-semibold'>Prototype and Test</h1>
                  <p data-aos='fade-right' data-aos-delay='100' className='text-base uppercase lg:mt-16 mt-6'>DESIGN. REFINE. TEST. REPEAT.</p>
                  <p className='lg:text-lg text-sm mt-6' data-aos='fade-up' data-aos-delay='200'>Ok, we have a great idea. Now it’s time to bring it to life and put it through its paces. Promising solutions are prototyped and tested to ensure they’re hitting the right notes with consumers and to reveal areas for improvement.</p>
            ...
            <div className='w-full h-4/5 lg:px-40 px-5 flex flex-col text-white'>
              <div className='w-full h-full flex lg:flex-row flex-col mt-12'>
                <div className='lg:w-1/2 w-full h-full'>
                  ...
                  <h1 className='lg:text-6xl text-3xl font-semibold'>Build</h1>
                ...
                <div className='lg:w-1/2 w-full lg:pt-40 pt-10 ht-10-full'>
                  ...
                  <p className='lg:text-lg text-sm mt-6' data-aos='fade-up' data-aos-delay='200'>Now it’s time for our elite dev teams to write beautiful modern code – delivered on time, on budget, and in full. Our production philosophy is simple: hit milestones with reliability, with deliverables that exceed expectations.</p>
            ...
            <div className='w-full h-3/5 lg:px-40 px-5 flex flex-col text-white'>
              <div className='w-full h-full flex lg:flex-row flex-col items-center mt-12'>
                ...
                <div className='lg:w-1/2 w-full mt-5 lg:mt-0'>
                  ...
                  <h1 className='lg:text-6xl text-3xl font-semibold'>Launch and Evaluate</h1>
                  <p data-aos='fade-right' data-aos-delay='100' className='text-base uppercase lg:mt-16 mt-6'>DEPLOYING WITH CONFIDENCE.</p>
                  <p className='lg:text-lg text-sm mt-6' data-aos='fade-up' data-aos-delay='200'>For some, the launch is the end. For us, it’s another crucial step. We’re with you in force to support deployment, measure performance, and continuously improve results. After all, we judge our success by yours.</p>
        ...
        <section className='w-full h-screen bg-black'>
          <div className='lg:pl-24 pl-12 w-full h-full flex items-center'>
            <div className='lg:w-2/3 w-full lg:pl-40 px-5 flex flex-col text-white'>
              {/* <p className='text-sm mb-4 uppercase'>what’s in the works?</p> */}
              <h1 data-aos='fade-right' className='lg:text-6xl text-3xl font-semibold'>Ready to <br /><span className='text-red-600'>work with us?</span></h1>
              <p data-aos='fade-right' data-aos-delay='100' className='lg:text-2xl text-xl lg:mt-16 mt-6'>Whatever your goal, let’s chat about how to get you there.</p>
