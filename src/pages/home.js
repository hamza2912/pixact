        ...
        <section className='w-full h-screen bg-black'>
          ...
          <div className='home-content lg:pl-24 pl-12 w-full h-full flex items-center'>
            <div className='lg:w-1/2 w-full lg:pl-40 px-5 flex flex-col text-white'>
              ...
              <h1 className='lg:text-6xl text-4xl font-semibold z-15'>We create modern experiences for tomorrow’s brands.</h1>
            </div>
          </div>
          <div className='absolute h-24 lg:left-64 left-20 bottom-0 see-our-work z-15'>
            <div className='h-full pl-3 border-l relative'>
              <p className='text-white uppercase lg:text-base text-xs'>See our Work</p>
        ...
        <section className='w-full h-screen bg-cover bg-approach'>
          <div className='home-content lg:pl-24 pl-12 w-full h-full flex items-center'>
            <div className='lg:w-1/2 w-full lg:pl-40 px-5 flex flex-col text-white'>
              ...
              <p data-aos='fade-up' className='lg:text-2xl text-lg mt-16'>Through a uniquely collaborative process that combines analytical and design thinking, creative sorcery, and an obsession with solving impossible problems.</p>
        ...
        <section className='w-full h-screen bg-black'>
          <div className='home-content lg:pl-24 pl-12 w-full h-full flex items-center'>
            <div className='lg:w-2/3 w-full lg:pl-40 px-5 flex flex-col text-white'>
              ...
              <h1 data-aos='fade-right' className='lg:text-5xl text-2xl font-semibold'>A dynamic react app for a multifunctional  <span className='text-red-600'>library</span>, transforming it's conventional outlook into a new <span className='text-red-600'>modern design</span>.</h1>
